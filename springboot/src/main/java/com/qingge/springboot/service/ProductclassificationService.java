...
@Service
public class ProductclassificationService extends ServiceImpl<ProductclassificationMapper,Productclassification>{
    public boolean saveProductclassification(Productclassification productclassification)
    {
        return saveOrUpdate(productclassification);
    }
