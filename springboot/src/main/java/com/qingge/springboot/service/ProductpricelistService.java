...
@Service
public class ProductpricelistService extends ServiceImpl<ProductpricelistMapper,Productpricelist>{
    public boolean saveProductpricelist(Productpricelist productpricelist)
    {
        return saveOrUpdate(productpricelist);
    }
